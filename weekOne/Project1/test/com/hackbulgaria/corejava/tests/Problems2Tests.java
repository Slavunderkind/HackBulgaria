...
public class Problems2Tests {
    ...
    public void testAnagrams() {
        ...
        // Грешен Unit test!
        // assertEquals(true, problems2.areAnagrams("том месвролуко риддъл",
        // "тук съм и лорд волдеморт"));
    }
    ...
    public void testDecodeUrl() {
        assertEquals("http://meyerweb.com/eric/tools/dencoder/",
                problems2.decodeURL("http%3A%2F%2Fmeyerweb.com%2Feric%2Ftools%2Fdencoder%2F"));
        assertEquals(
                "http://javarevisited.blogspot.com/2012/10/10-java-string-interview-question-answers-top.html",
                problems2
                        .decodeURL("http%3A%2F%2Fjavarevisited.blogspot.com%2F2012%2F10%2F10-java-string-interview-question-answers-top.html"));
    }
    ...
    public void testMaxSpan() {
        ...
        assertEquals(8, problems2.maxSpan(new int[] { 1, 4, 2, 1, 4, 4, 4 }));
    }
